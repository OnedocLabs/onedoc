export class HtmlBuilder {
  ...
  build(document: string, styleSheets?: string[], dev = true) {
    ...
    if (dev == true){ // adds watermak for dev renderings

      this.middle += `<div style="position: absolute;left: 0;top: 50%;margin:0;padding:0;transform: translateY(-50%);width: 0px;text-align: left;writing-mode: vertical-lr;transform-origin: left;">
